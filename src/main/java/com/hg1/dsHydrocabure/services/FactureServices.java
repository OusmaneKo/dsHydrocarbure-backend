...
import com.hg1.dsHydrocabure.models.Factures;
import com.hg1.dsHydrocabure.repositories.FactureRepository;
...
public class FactureServices {
    ...
    public FactureServices(FactureRepository factureRepository) {
    ...
    public ResponseWrapper<Factures> update(Factures fac, Long id){
        try {
